    ...
    <div className="min-h-screen" style={{ backgroundColor: '#f9f1e7', color: '#3b3b3b' }}>
      ...
      >
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-2 opacity-60 hover:opacity-90 transition-opacity cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <ChevronUp className="w-7 h-7 animate-bounce" style={{ animationDirection: 'reverse' }} />
            <div className="w-px h-10 bg-gradient-to-b from-pink-400/60 to-transparent" />
          </div>
        </div>
      </section>
      ...
      {wedding.backgroundMusicUrl && (
        <BackgroundMusicPlayer
          ...
          theme={{ primary: '#f472b6', accent: '#fb7185', iconColor: '#ffffff', glow: 'rgba(244,114,182,0.45)' }}
        />
      )}
    </div>
  );
