  ...
  return (
    <div className="min-h-screen bg-[#1a1530] text-white overflow-x-hidden" style={{ fontFamily: '"Lato", sans-serif' }}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              {memoryPhotos.map((photo: any, i: number) => (
                <motion.div
                  ...
                  className="aspect-square overflow-hidden rounded-3xl border border-white/15 bg-[#1a1530]"
                >
                  <img
                    src={photo.url}
                    alt={photo.caption || ''}
      ...
      <footer className="relative z-10 py-14 px-6 border-t border-white/10 text-center">
        {show('orderCta') && <OrderInvitationCTA accent="#c9b6e3" surface="dark" className="mb-12" />}
        <div className="flex items-center justify-center gap-3 mb-5">
